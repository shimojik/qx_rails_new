...
ActiveRecord::Schema[8.0].define(version: 2025_03_22_000004) do
  ...
  create_table "solid_cable_messages", force: :cascade do |t|
    ...
    t.index ["stream_id"], name: "index_solid_cable_messages_on_stream_id"
  end
  ...
  create_table "solid_cable_streams", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_solid_cable_streams_on_name", unique: true
  end

  create_table "solid_cable_subscriptions", force: :cascade do |t|
    t.bigint "stream_id", null: false
    t.string "connection_id", null: false
    t.datetime "created_at", null: false
    t.index ["connection_id", "stream_id"], name: "index_solid_cable_subscriptions_on_connection_id_and_stream_id", unique: true
    t.index ["connection_id"], name: "index_solid_cable_subscriptions_on_connection_id"
    t.index ["stream_id"], name: "index_solid_cable_subscriptions_on_stream_id"
  end
  ...
  create_table "solid_queue_jobs", force: :cascade do |t|
    ...
    t.index ["concurrency_key", "finished_at"], name: "index_solid_queue_jobs_on_concurrency_key_and_finished_at", where: "(concurrency_key IS NOT NULL)"
